  ...
  return (
    <div className="outer">
      ...
      <div className="text-wrapper-full-guide">
        ...
        select your currency. Type values in either side of the converter,
        depending on if you have money to exchange or if you want money to
        purchase items costing a certain amount.
        <br />
        <br />
